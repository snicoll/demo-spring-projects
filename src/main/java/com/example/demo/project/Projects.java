...
class Projects {
	...
	private final Map<String, ProjectSummary> projectData = Map.of(
			"spring-framework", new ProjectSummary("spring-framework", "Spring Framework"),
			"spring-boot", new ProjectSummary("spring-boot", "Spring Boot")
	);

	private final Map<String, ProjectReleases> releaseData = Map.of(
			"spring-framework", new ProjectReleases(List.of(
			...
			"spring-boot", new ProjectReleases(List.of(
